...
def test_phones_on_homepage(app):
    ...
    assert(contacts_from_phone_app.home == app.contacts.clear(contacts_from_edit_page.home))
    assert(contacts_from_phone_app.mobile == app.contacts.clear(contacts_from_edit_page.mobile))
    assert(contacts_from_phone_app.work == app.contacts.clear(contacts_from_edit_page.work))
